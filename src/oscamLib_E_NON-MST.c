...
#define LIB_TV_MODELS "E"
#define LIB_HOOKS libOscamE_NON_MST_hooks
#define hCTX libOscamE_NON_MST_hook_ctx
        ...
        void *_h, const char *libpath)
{
	...
	log("spITsd_Open=%d, g_hDesc = 0x%08X\n", hCTX.spITsd_Open(4096, &g_demux[0].hDesc), g_demux[0].hDesc);
